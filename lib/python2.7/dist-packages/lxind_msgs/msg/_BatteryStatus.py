...
class BatteryStatus(genpy.Message):
  _md5sum = "6ae031e03520d0f6e4de397af6dff15a"
...
float32 batt_life
float32 temper_alarm_low
float32 temper_alarm_high
...
string frame_id
"""
  __slots__ = ['header','voltage','current','remain_bat','full_bat','cell_volt','tempterature','batt_cycle','design_capacity','batt_life','temper_alarm_low','temper_alarm_high','remaining_percentage','is_charging','is_battery_low','is_battery_full','port']
  _slot_types = ['std_msgs/Header','uint16','int16','uint16','uint16','uint16[]','uint16[]','uint16','uint16','float32','float32','float32','uint8','bool','bool','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,voltage,current,remain_bat,full_bat,cell_volt,tempterature,batt_cycle,design_capacity,batt_life,temper_alarm_low,temper_alarm_high,remaining_percentage,is_charging,is_battery_low,is_battery_full,port
    ...
    if args or kwds:
      ...
      if self.batt_life is None:
        self.batt_life = 0.
      if self.temper_alarm_low is None:
        self.temper_alarm_low = 0.
      if self.temper_alarm_high is None:
        self.temper_alarm_high = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2H3f4B().pack(_x.batt_cycle, _x.design_capacity, _x.batt_life, _x.temper_alarm_low, _x.temper_alarm_high, _x.remaining_percentage, _x.is_charging, _x.is_battery_low, _x.is_battery_full))
      _x = self.port
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.batt_cycle, _x.design_capacity, _x.batt_life, _x.temper_alarm_low, _x.temper_alarm_high, _x.remaining_percentage, _x.is_charging, _x.is_battery_low, _x.is_battery_full,) = _get_struct_2H3f4B().unpack(str[start:end])
...
def _get_struct_Hh2H():
    ...
    return _struct_Hh2H
_struct_2H3f4B = None
def _get_struct_2H3f4B():
    global _struct_2H3f4B
    if _struct_2H3f4B is None:
        _struct_2H3f4B = struct.Struct("<2H3f4B")
    return _struct_2H3f4B
