...
if("FALSE" STREQUAL "TRUE")
  set(rosapi_SOURCE_PREFIX /home/zhangchunlei/lxind_ws/src/lxind_util/rosbridge_suite/rosapi)
  set(rosapi_DEVEL_PREFIX /home/zhangchunlei/lxind_ws/devel)
  set(rosapi_INSTALL_PREFIX "")
  set(rosapi_PREFIX ${rosapi_DEVEL_PREFIX})
else()
  set(rosapi_SOURCE_PREFIX "")
  set(rosapi_DEVEL_PREFIX "")
  set(rosapi_INSTALL_PREFIX /home/zhangchunlei/lxind_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosapi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhangchunlei/lxind_ws/install/${idir}'.  ${_report}")
    endif()
