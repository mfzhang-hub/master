...
if("FALSE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/zhangchunlei/lxind_ws/src/lxind_util/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/zhangchunlei/lxind_ws/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/zhangchunlei/lxind_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhangchunlei/lxind_ws/install/${idir}'.  ${_report}")
    endif()
