...
if [ -z "$wifi_card" ]; then
    ...
    echo "$ttime wifi_card:$wifi_card wifi_name:$wifi_name ap_name:$ap_name signal_strength:$signal_strength dbm delay:$delay ms network_card:$network_card " >> ~/interface.txt
fi
